        ...
        with gr.TabItem("\N{rocket}模型定制") as tab_train:
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    audio_lst1 = [
                        gr.Audio(label="1. 清晨，阳光洒满小路，花儿含笑迎接新一天。"),
                        gr.Audio(label="2. 树梢上鸟儿歌唱，旋律悠扬。公园中，松鼠忙碌，秋日收获。"),
                        gr.Audio(label="3. 花园里，蝴蝶轻舞，狗狗追逐着飘落的叶子，欢乐满溢。"),
                        gr.Audio(label="4. 河边，小鸭戏水，水波荡漾，映出欢快身影。"),
                        gr.Audio(label="5. 蓝天下，花儿开放，绽放生机，小猫追逐彩色的梦。"),
                    ]
                with gr.Column(scale=1):
                    audio_lst2 = [
                        gr.Audio(label="6. 林间小径，草地上，松鼠跳跃，觅得果实分享喜悦。"),
                        gr.Audio(label="7. 海边，螃蟹踏着轻快步伐，留下一串足迹。"),
                        gr.Audio(label="8. 夕阳西下，蝴蝶飞舞，小兔听见晚风诉说着故事。"),
                        gr.Audio(label="9. 星空闪烁，小狐狸仰望，许下心中愿望。"),
                        gr.Audio(label="10. 早市上，小猪噜噜噜，探寻新鲜蔬果的香气。"),
                    ]
                with gr.Column(scale=1):
                    audio_lst3 = [
                        gr.Audio(label="11. Dawn breaks, and the path is bathed in sunlight, flowers smiling at the day."),
                        gr.Audio(label="12. By the river, ducklings splash, rippling water reflects their joy."),
                        gr.Audio(label="13. On the hill, sheep graze leisurely, a cool breeze whispers."),
                        gr.Audio(label="14. Under the blue sky, a rainbow stretches, a kitten chases colorful dreams."),
                        gr.Audio(label="15. In the woods, squirrels leap, sharing the joy of found fruits."),
                    ]
                with gr.Column(scale=1):
                    audio_lst4 = [
                        gr.Audio(label="16. At the beach, crabs walk briskly, leaving a trail of footprints."),
                        gr.Audio(label="17. As the sun sets, a bunny hears stories whispered by the evening wind."),
                        gr.Audio(label="18. Stars twinkle, a fox gazes up, making a secret wish."),
                        gr.Audio(label="19. In the morning market, a piglet sniffs, seeking the scent of fresh produce."),
                        gr.Audio(label="20. On the meadow, butterflies flutter, flowers bloom, bursting with life."),
                    ]
            # One task at a time
